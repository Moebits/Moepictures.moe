                ...
                <div className="mod-post" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} key={i}>
                    ...
                    <div className="mod-post-text-container">
                        ...
                        <div className="mod-post-text-container-row" style={{padding: "10px", paddingBottom: "0px"}}>
                            <span className="mod-post-link" onClick={() => navigate(`/user/${post.appealer}`)}>{i18n.labels.appealer}: {functions.toProperCase(post.appealer || "") || i18n.user.deleted}</span>
                        ...
                        <div className="mod-post-text-container-row">
                            <div className="mod-post-text-column">
                                <span className="mod-post-link" onClick={() => navigate(`/user/${post.uploader}`)}>{i18n.sidebar.uploader}: {functions.toProperCase(post?.uploader) || i18n.user.deleted}</span>
