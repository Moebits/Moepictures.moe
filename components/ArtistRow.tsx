...
const ArtistRow: React.FunctionComponent = (props) => {
    ...
    return (
        <div className="artistrow" onMouseEnter={() =>setHover(true)} onMouseLeave={() => setHover(false)}>
            <div className="artistrow-row">
                <img className="artistrow-img" src={artistImg}/>
                <span className="artistrow-text-hover">
                    <span className="artistrow-text">Liely</span>
                    <span className="artistrow-text-alt">405</span>
                </span>
            </div>
            <div className="artistrow-row">
