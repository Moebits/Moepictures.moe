...
const SeriesRow: React.FunctionComponent = (props) => {
    ...
    return (
        <div className="seriesrow" onMouseEnter={() =>setHover(true)} onMouseLeave={() => setHover(false)}>
            <div className="seriesrow-row">
                <img className="seriesrow-img" src={seriesImg}/>
                <span className="seriesrow-text-hover">
                    <span className="seriesrow-text">Genshin Impact</span>
                    <span className="seriesrow-text-alt">433443</span>
                </span>
            </div>
            <div className="seriesrow-row">
