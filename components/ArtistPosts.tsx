...
const ArtistPosts: React.FunctionComponent<Props> = (props) => {
    ...
    return (
        <div className="related">
            <div className="related-title">Artist Posts</div>
            <div className="related-container">
                <Carousel images={getImages()} set={click} noKey={true} marginLeft={200}/>
            </div>
        </div>
    )
}
