...
const ModTagAliases: React.FunctionComponent = (props) => {
    ...
    const [requests, setRequests] = useState([] as AliasRequest[])
    const [index, setIndex] = useState(0)
    const [visibleRequests, setVisibleRequests] = useState([] as AliasRequest[])
    ...
    const updateVisibleRequests = () => {
        const newVisibleRequests = [] as AliasRequest[]
