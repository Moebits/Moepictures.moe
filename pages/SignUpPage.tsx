            ...
            <div className="content">
                <div className="sitepage">
                    ...
                    <div className="sitepage-row">
                        <span className="sitepage-text-wide2">{i18n.labels.emailAddress}:</span>
                    ...
                    <div className="sitepage-row">
                        <span className="sitepage-text-wide2">{i18n.labels.username}:</span>
                    ...
                    <div className="sitepage-row">
                        <span className="sitepage-text-wide2">{i18n.labels.password}:</span>
                    ...
                    <div className="sitepage-row">
                        <span className="sitepage-text-wide2">{i18n.labels.confirmPassword}:</span>
                        <div className="sitepage-pass">
