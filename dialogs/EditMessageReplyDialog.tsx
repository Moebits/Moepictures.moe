            ...
            <div className="dialog">
                ...
                <div className="dialog-box" onMouseEnter={() => setEnableDrag(false)} onMouseLeave={() => setEnableDrag(true)}>
                    <div className="dialog-container">
                        ...
                        <div className="dialog-row">
                            <textarea className="dialog-textarea" style={{height: "230px"}} spellCheck={false} value={editMsgReplyContent} onChange={(event) => setEditMsgReplyContent(event.target.value)}></textarea>
                        </div>
