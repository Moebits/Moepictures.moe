...
export const useSearchSelector = () => {
    ...
    return {
        ...
        selectionItems: selector(createSelector((state) => state.search.selectionItems, (items) => new Set<string>(items))),
        selectionPosts: selector(createSelector((state) => state.search.selectionPosts, (items) => new Map<string, any>(Object.entries(items)))),
