...
const VerifyEmail = (props: Props) => {
    ...
    return (
        <Html lang="en">
            ...
            <Preview>Moepictures Email Verification</Preview>
            <Body style={{width: "85%"}}>
                ...
                <Container style={textContainer}>
                    <Text style={text}>
                        ...
                        Thanks for creating a Moepictures account! Please confirm your email to 
                        finish signing up. *If the link doesn't work, take this email 
                        out of the spam folder. <br/>
                    </Text>
                </Container>
                <Container style={buttonContainer}>
                    <Button style={button} href={link}>
                        <Text style={buttonText} className="button-text">Verify Email</Text>
                    </Button>
                </Container>
            </Body>
        </Html>
